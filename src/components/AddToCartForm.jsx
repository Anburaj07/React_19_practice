...
const AddToCartForm = ({ itemID, itemTitle }) => {
  ...
  return (
    ...
    >
      ...
      <input type="hidden" name="itemID" value={itemID} className="hidden" />
      <button
        type="submit"
...
const addToCart = (prevState, querryData) => {
  const itemID = querryData.get("itemID");
  if (itemID == "1") {
    return "Added to cart";
  } else {
    return "Could not add to cart: Item is sld out";
  }
};
